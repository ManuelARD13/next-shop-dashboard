    ...
    if (product) {
      ...
      addProduct(data)
        .then(() => {
          setAlert({
            active: true,
            message: 'Product added sucesssfully',
            type: 'success',
            autoClose: false,
          });
          setOpen(false);
          ...
          <div className="grid grid-cols-6 gap-6">
            ...
            <div className="col-span-6">
              ...
              <textarea
                ...
                rows="3"
                className="form-textarea w-full mt-1 focus:ring-indigo-500 focus:border-indigo-500 shadow-sm sm:text-sm border-gray-300 rounded-md"
                required
              />
            </div>
            <div className="col-span-6">
